...
Target accepted threats: `20`
Source candidates with source image: `20/20`
Source candidates mechanically ready for review: `20/20`
Source candidates approval-ready now: `20/20`
Source candidates requiring critic regeneration: `0`
Approved source candidates: `0/20`
Source generation queue: `0` candidates
Rejected source generation attempts: `21`
Registered articulated threats: `33`
Accepted articulated threats: `0/20`
Strict gate complete: `false`
Sandbox visual reports: `18`; unique checked ids: `125/125`; failures: `0`

Next bottleneck: **approve 20 source candidates (20 approval-ready)**
...
Species: **Brine Crown** (`brine-crown`)

Score: `10`

Why this target:
- not approved by human source review
...
No missing-source candidates.

## Recent Source Generation Rejections

- **Glass Sponge Sentinel** (`glass-sponge-sentinel`) at `2026-06-17T15:53:26.354Z`: Built-in image generation rendered a Glass Sponge Sentinel candidate inline, but no new recoverable image file appeared under CODEX_HOME/generated_images for project ingestion.
- **Glass Sponge Sentinel** (`glass-sponge-sentinel`) at `2026-06-17T14:25:36.509Z`: Built-in image generation rendered inline for glass-sponge-sentinel, but no repository-visible image file appeared under /home/orlovboros/.codex/generated_images for automatic ingest.
- **Glass Sponge Sentinel** (`glass-sponge-sentinel`) at `2026-06-17T13:33:35.374Z`: Built-in image generation produced only inline chat output; no recoverable file appeared under /home/orlovboros/.codex/generated_images after the marker.
- **Gulper Eel Maw** (`gulper-eel-maw`) at `2026-06-17T12:45:34.200Z`: Built-in image generation rendered an inline Gulper Eel Maw candidate, but no new or modified recoverable file appeared under /home/orlovboros/.codex/generated_images after the handoff marker, so it cannot be validated or ingested without manual capture.
- **Gulper Eel Maw** (`gulper-eel-maw`) at `2026-06-17T10:54:50.100Z`: Built-in image generation displayed a promising inline Gulper Eel Maw source image, but no new or modified recoverable file appeared under /home/orlovboros/.codex/generated_images after the marker, so it cannot be validated or ingested.
- **Gulper Eel Maw** (`gulper-eel-maw`) at `2026-06-17T09:57:21.492Z`: Built-in image generation rendered an inline Gulper Eel Maw image in the client, but no new or modified project-recoverable image file appeared under CODEX_HOME or the workspace for ingestion.
- **Gulper Eel Maw** (`gulper-eel-maw`) at `2026-06-17T05:26:11.141Z`: Built-in image generation rendered inline after the handoff marker, but no new or modified image file appeared under /home/orlovboros/.codex/generated_images, /home/orlovboros/.codex, or the project workspace for ingestion.
- **Gulper Eel Maw** (`gulper-eel-maw`) at `2026-06-17T03:49:27.889Z`: Built-in image generation rendered inline but produced no recoverable file under /home/orlovboros/.codex/generated_images for project ingestion.

## Source Candidate Readiness

### Brine Crown (brine-crown)

Status: `needs-review`; source: `true`; approved: `false`
...
Next commands:
```bash
npm run source:quick-review -- --id glass-sponge-sentinel
...
Next commands:
```bash
npm run source:quick-review -- --id black-coral-gate
...
Next commands:
```bash
npm run source:quick-review -- --id reliquary-siphonophore
...
Next commands:
```bash
npm run source:quick-review -- --id hadal-trencher-isopod
...
Next commands:
```bash
npm run source:quick-review -- --id vent-claw-yeti
...
Next commands:
```bash
npm run source:quick-review -- --id abyssal-lantern-mantis
...
Next commands:
```bash
npm run source:quick-review -- --id trench-harvest-sea-spider
...
Next commands:
```bash
npm run source:quick-review -- --id coronate-sting-crown
...
Next commands:
```bash
npm run source:quick-review -- --id chain-vein-siphonophore
...
Next commands:
```bash
npm run source:quick-review -- --id vampire-cloak-squid
...
Next commands:
```bash
npm run source:quick-review -- --id predatory-tunicate-maw
...
Next commands:
```bash
npm run source:quick-review -- --id razor-kelp-harp
...
Next commands:
```bash
npm run source:quick-review -- --id lantern-anemone-pit
...
Next commands:
```bash
npm run source:quick-review -- --id brine-mycelium-shelf
...
Next commands:
```bash
npm run source:quick-review -- --id thorn-fan-coralline
...
Next commands:
```bash
npm run source:quick-review -- --id gulper-eel-maw
...
Next commands:
```bash
npm run source:quick-review -- --id saber-viperfish
...
Next commands:
```bash
npm run source:quick-review -- --id tripod-stilt-stalker
...
Next commands:
```bash
npm run source:quick-review -- --id reef-lion-moray
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id abyssal-gulper --with diver --visual
npm run sandbox:visual -- --ids abyssal-gulper --states idle,lunge,stunned --with diver
npm run content:accept -- --id abyssal-gulper --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```

### Abyssal Crownmaw (abyssal-crownmaw)
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id abyssal-crownmaw --with diver --visual
npm run sandbox:visual -- --ids abyssal-crownmaw --states idle,lunge,stunned --with diver
npm run content:accept -- --id abyssal-crownmaw --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```

### Chainmaw Eel (chainmaw-eel)
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id chainmaw-eel --with diver --visual
npm run sandbox:visual -- --ids chainmaw-eel --states idle,lunge,stunned --with diver
npm run content:accept -- --id chainmaw-eel --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```

### Sawback Ray (sawback-ray)
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id sawback-ray --with diver --visual
npm run sandbox:visual -- --ids sawback-ray --states idle,lunge,stunned --with diver
npm run content:accept -- --id sawback-ray --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```

### Thornhalo Urchin (thornhalo-urchin)
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id thornhalo-urchin --with diver --visual
npm run sandbox:visual -- --ids thornhalo-urchin --states idle,lunge,stunned --with diver
npm run content:accept -- --id thornhalo-urchin --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```

### Hookjaw Isopod (hookjaw-isopod)
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id hookjaw-isopod --with diver --visual
npm run sandbox:visual -- --ids hookjaw-isopod --states idle,lunge,stunned --with diver
npm run content:accept -- --id hookjaw-isopod --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```

### Cavitation Boxer (cavitation-boxer)
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id cavitation-boxer --with diver --visual
npm run sandbox:visual -- --ids cavitation-boxer --states idle,lunge,stunned --with diver
npm run content:accept -- --id cavitation-boxer --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```

### Siphon Lily (siphon-lily)
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id siphon-lily --with diver --visual
npm run sandbox:visual -- --ids siphon-lily --states idle,lunge,stunned --with diver
npm run content:accept -- --id siphon-lily --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```

### Harpoon Cone (harpoon-cone)
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id harpoon-cone --with diver --visual
npm run sandbox:visual -- --ids harpoon-cone --states idle,lunge,stunned --with diver
npm run content:accept -- --id harpoon-cone --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```

### Sand Battery (sand-battery)
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id sand-battery --with diver --visual
npm run sandbox:visual -- --ids sand-battery --states idle,lunge,stunned --with diver
npm run content:accept -- --id sand-battery --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```

### Trap-Jaw Bristle (trap-jaw-bristle)
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id trap-jaw-bristle --with diver --visual
npm run sandbox:visual -- --ids trap-jaw-bristle --states idle,lunge,stunned --with diver
npm run content:accept -- --id trap-jaw-bristle --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```

### Velvet Lantern Cuttle (velvet-lantern-cuttle)
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id velvet-lantern-cuttle --with diver --visual
npm run sandbox:visual -- --ids velvet-lantern-cuttle --states idle,lunge,stunned --with diver
npm run content:accept -- --id velvet-lantern-cuttle --status accepted --reviewed-by <human-reviewer> --source-candidate <approved-source-candidate-id> --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```
...
Blockers:
- linked source candidate is not approved
- quality.status is prototype, expected accepted
- runtime/review quality metadata mismatch
- not accepted by strict quality metadata
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id glass-sponge-sentinel --with diver --visual
npm run sandbox:visual -- --ids glass-sponge-sentinel --states idle,lunge,stunned --with diver
npm run content:accept -- --id glass-sponge-sentinel --status accepted --reviewed-by <human-reviewer> --source-candidate glass-sponge-sentinel --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id reliquary-siphonophore --with diver --visual
npm run sandbox:visual -- --ids reliquary-siphonophore --states idle,lunge,stunned --with diver
npm run content:accept -- --id reliquary-siphonophore --status accepted --reviewed-by <human-reviewer> --source-candidate reliquary-siphonophore --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id hadal-trencher-isopod --with diver --visual
npm run sandbox:visual -- --ids hadal-trencher-isopod --states idle,lunge,stunned --with diver
npm run content:accept -- --id hadal-trencher-isopod --status accepted --reviewed-by <human-reviewer> --source-candidate hadal-trencher-isopod --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id abyssal-lantern-mantis --with diver --visual
npm run sandbox:visual -- --ids abyssal-lantern-mantis --states idle,lunge,stunned --with diver
npm run content:accept -- --id abyssal-lantern-mantis --status accepted --reviewed-by <human-reviewer> --source-candidate abyssal-lantern-mantis --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id brine-mycelium-shelf --with diver --visual
npm run sandbox:visual -- --ids brine-mycelium-shelf --states idle,lunge,stunned --with diver
npm run content:accept -- --id brine-mycelium-shelf --status accepted --reviewed-by <human-reviewer> --source-candidate brine-mycelium-shelf --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id coronate-sting-crown --with diver --visual
npm run sandbox:visual -- --ids coronate-sting-crown --states idle,lunge,stunned --with diver
npm run content:accept -- --id coronate-sting-crown --status accepted --reviewed-by <human-reviewer> --source-candidate coronate-sting-crown --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```
...
```bash
npm run review:articulated:quick
npm run sandbox:preview -- --id razor-kelp-harp --with diver --visual
npm run sandbox:visual -- --ids razor-kelp-harp --states idle,lunge,stunned --with diver
npm run content:accept -- --id razor-kelp-harp --status accepted --reviewed-by <human-reviewer> --source-candidate razor-kelp-harp --note '<specific rig approval note>' --visual-check single-source-cohesion --visual-check readable-silhouette --visual-check anatomy-cohesion --visual-check production-visual-cohesion --visual-check socket-seams --visual-check motion-stability --visual-check sandbox-behavior --score single-source-cohesion=<4-5> --score readable-silhouette=<4-5> --score anatomy-cohesion=<4-5> --score production-visual-cohesion=<4-5> --score socket-seams=<4-5> --score motion-stability=<4-5> --score sandbox-behavior=<4-5> --visual-note single-source-cohesion='<specific rationale>' --visual-note readable-silhouette='<specific rationale>' --visual-note anatomy-cohesion='<specific rationale>' --visual-note production-visual-cohesion='<specific rationale>' --visual-note socket-seams='<specific rationale>' --visual-note motion-stability='<specific rationale>' --visual-note sandbox-behavior='<specific rationale>' --source-reviewed --contact-reviewed --phase-reviewed --parity-reviewed --sandbox-reviewed --dry-run
```
