# Rigging Focus Pack: Predatory Tunicate Maw (predatory-tunicate-maw)
...
Runtime creature: `predatory-tunicate-maw`
...
```bash
npm run sandbox:preview -- --id predatory-tunicate-maw --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/predatory-tunicate-maw-starter-plan.json
```
...
npm run content:quick-review -- --id predatory-tunicate-maw
