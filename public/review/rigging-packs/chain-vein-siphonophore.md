# Rigging Focus Pack: Chain Vein Siphonophore (chain-vein-siphonophore)
...
Runtime creature: `chain-vein-siphonophore`
...
```bash
npm run sandbox:preview -- --id chain-vein-siphonophore --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/chain-vein-siphonophore-starter-plan.json
```
...
npm run content:quick-review -- --id chain-vein-siphonophore
