# Rigging Focus Pack: Vent-Claw Yeti (vent-claw-yeti)
...
Runtime creature: `vent-claw-yeti`
...
```bash
npm run sandbox:preview -- --id vent-claw-yeti --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/vent-claw-yeti-starter-plan.json
```
...
npm run content:quick-review -- --id vent-claw-yeti
