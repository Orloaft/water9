# Rigging Focus Pack: Brine Mycelium Shelf (brine-mycelium-shelf)

Generated: `2026-06-18T17:06:58.874Z`
Stage: `human-source-review-needed`
Source: `public/assets/generated/fauna-brine-mycelium-shelf-whole-source.png`
Runtime creature: `brine-mycelium-shelf`
...
```bash
npm run sandbox:preview -- --id brine-mycelium-shelf --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/brine-mycelium-shelf-starter-plan.json
```
...
npm run content:quick-review -- --id brine-mycelium-shelf
