# Rigging Focus Pack: Reliquary Siphonophore (reliquary-siphonophore)
...
Runtime creature: `reliquary-siphonophore`
...
```bash
npm run sandbox:preview -- --id reliquary-siphonophore --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/reliquary-siphonophore-starter-plan.json
```
...
npm run content:quick-review -- --id reliquary-siphonophore
