# Rigging Focus Pack: Tripod Stilt Stalker (tripod-stilt-stalker)
...
Runtime creature: `tripod-stilt-stalker`
...
```bash
npm run sandbox:preview -- --id tripod-stilt-stalker --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/tripod-stilt-stalker-starter-plan.json
```
...
npm run content:quick-review -- --id tripod-stilt-stalker
