# Rigging Focus Pack: Black Coral Gate (black-coral-gate)
...
Runtime creature: `black-coral-gate`
...
```bash
npm run sandbox:preview -- --id black-coral-gate --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/black-coral-gate-starter-plan.json
```
...
npm run content:quick-review -- --id black-coral-gate
