# Rigging Focus Pack: Lantern Anemone Pit (lantern-anemone-pit)

Generated: `2026-06-18T17:06:58.873Z`
Stage: `human-source-review-needed`
Source: `public/assets/generated/fauna-lantern-anemone-pit-whole-source.png`
Runtime creature: `lantern-anemone-pit`
...
```bash
npm run sandbox:preview -- --id lantern-anemone-pit --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/lantern-anemone-pit-starter-plan.json
```
...
npm run content:quick-review -- --id lantern-anemone-pit
