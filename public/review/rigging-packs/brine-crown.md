# Rigging Focus Pack: Brine Crown (brine-crown)

Generated: `2026-06-18T17:06:58.867Z`
Stage: `human-source-review-needed`
Source: `public/assets/generated/fauna-brine-crown-whole-source.png`
Runtime creature: `brine-crown`
...
```bash
npm run sandbox:preview -- --id brine-crown --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/brine-crown-starter-plan.json
```
