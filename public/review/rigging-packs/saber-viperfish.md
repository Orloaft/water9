# Rigging Focus Pack: Saber Viperfish (saber-viperfish)
...
Runtime creature: `saber-viperfish`
...
```bash
npm run sandbox:preview -- --id saber-viperfish --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/saber-viperfish-starter-plan.json
```
...
npm run content:quick-review -- --id saber-viperfish
