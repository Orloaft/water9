# Rigging Focus Pack: Abyssal Lantern Mantis (abyssal-lantern-mantis)
...
Runtime creature: `abyssal-lantern-mantis`
...
```bash
npm run sandbox:preview -- --id abyssal-lantern-mantis --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/abyssal-lantern-mantis-starter-plan.json
```
...
npm run content:quick-review -- --id abyssal-lantern-mantis
