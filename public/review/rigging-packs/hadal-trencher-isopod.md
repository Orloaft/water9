# Rigging Focus Pack: Hadal Trencher Isopod (hadal-trencher-isopod)

Generated: `2026-06-18T17:06:58.870Z`
Stage: `human-source-review-needed`
Source: `public/assets/generated/fauna-hadal-trencher-isopod-whole-source.png`
Runtime creature: `hadal-trencher-isopod`
...
```bash
npm run sandbox:preview -- --id hadal-trencher-isopod --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/hadal-trencher-isopod-starter-plan.json
```
...
npm run content:quick-review -- --id hadal-trencher-isopod
