# Rigging Focus Pack: Coronate Sting Crown (coronate-sting-crown)

Generated: `2026-06-18T17:06:58.871Z`
Stage: `human-source-review-needed`
Source: `public/assets/generated/fauna-coronate-sting-crown-whole-source.png`
Runtime creature: `coronate-sting-crown`
...
```bash
npm run sandbox:preview -- --id coronate-sting-crown --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/coronate-sting-crown-starter-plan.json
```
...
npm run content:quick-review -- --id coronate-sting-crown
