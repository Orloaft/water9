# Rigging Focus Pack: Gulper Eel Maw (gulper-eel-maw)
...
Runtime creature: `gulper-eel-maw`
...
```bash
npm run sandbox:preview -- --id gulper-eel-maw --kind source --best --serve --open --visual
```
...
npm run articulated:extract-plan -- --plan tools/scratch/gulper-eel-maw-starter-plan.json
```
...
npm run content:quick-review -- --id gulper-eel-maw
