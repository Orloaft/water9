# Acceptance Packet: Abyssal Lantern Mantis (abyssal-lantern-mantis)
...
- Runtime id: `abyssal-lantern-mantis`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/abyssal-lantern-mantis.md`
- Rigging pack: `rigging-packs/abyssal-lantern-mantis.md`
- Sandbox URL: `/?sandbox=abyssal-lantern-mantis`
...
```bash
npm run content:rigging-pack -- --id abyssal-lantern-mantis
npm run articulated:prepare-plan -- --id abyssal-lantern-mantis --plan tools/scratch/abyssal-lantern-mantis-starter-plan.json --preview public/review/articulated/abyssal-lantern-mantis-plan-preview.png
