# Acceptance Packet: Brine Crown (brine-crown)
...
- Source review packet: `public/review/source-candidates/source-review-packets/brine-crown.md`
- Rigging pack: `rigging-packs/brine-crown.md`
- Sandbox URL: `/?sandbox=brine-crown`
...
```bash
npm run content:rigging-pack -- --id brine-crown
npm run articulated:prepare-plan -- --id brine-crown --plan tools/scratch/brine-crown-starter-plan.json --preview public/review/articulated/brine-crown-plan-preview.png
