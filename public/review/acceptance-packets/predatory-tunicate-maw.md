# Acceptance Packet: Predatory Tunicate Maw (predatory-tunicate-maw)
...
- Runtime id: `predatory-tunicate-maw`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/predatory-tunicate-maw.md`
- Rigging pack: `rigging-packs/predatory-tunicate-maw.md`
- Sandbox URL: `/?sandbox=predatory-tunicate-maw`
...
```bash
npm run content:rigging-pack -- --id predatory-tunicate-maw
npm run articulated:prepare-plan -- --id predatory-tunicate-maw --plan tools/scratch/predatory-tunicate-maw-starter-plan.json --preview public/review/articulated/predatory-tunicate-maw-plan-preview.png
