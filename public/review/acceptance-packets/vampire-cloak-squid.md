# Acceptance Packet: Vampire Cloak Squid (vampire-cloak-squid)
...
- Runtime id: `vampire-cloak-squid`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/vampire-cloak-squid.md`
- Rigging pack: `rigging-packs/vampire-cloak-squid.md`
- Sandbox URL: `/?sandbox=vampire-cloak-squid`
...
```bash
npm run content:rigging-pack -- --id vampire-cloak-squid
