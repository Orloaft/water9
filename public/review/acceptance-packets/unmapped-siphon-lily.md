# Unmapped Prototype Packet: Siphon Lily (siphon-lily)
...
- Sandbox URL: `/?sandbox=siphon-lily`

```bash
npm run sandbox:preview -- --id siphon-lily --with diver --serve --open --visual
npm run sandbox:visual -- --ids siphon-lily --states idle,lunge,stunned --with diver
npm run content:acceptance-audit -- --id siphon-lily
```
