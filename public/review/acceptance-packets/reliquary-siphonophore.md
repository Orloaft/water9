# Acceptance Packet: Reliquary Siphonophore (reliquary-siphonophore)
...
- Runtime id: `reliquary-siphonophore`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/reliquary-siphonophore.md`
- Rigging pack: `rigging-packs/reliquary-siphonophore.md`
- Sandbox URL: `/?sandbox=reliquary-siphonophore`
...
```bash
npm run content:rigging-pack -- --id reliquary-siphonophore
npm run articulated:prepare-plan -- --id reliquary-siphonophore --plan tools/scratch/reliquary-siphonophore-starter-plan.json --preview public/review/articulated/reliquary-siphonophore-plan-preview.png
