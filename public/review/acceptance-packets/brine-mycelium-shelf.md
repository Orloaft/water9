# Acceptance Packet: Brine Mycelium Shelf (brine-mycelium-shelf)
...
- Runtime id: `brine-mycelium-shelf`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/brine-mycelium-shelf.md`
- Rigging pack: `rigging-packs/brine-mycelium-shelf.md`
- Sandbox URL: `/?sandbox=brine-mycelium-shelf`
...
```bash
npm run content:rigging-pack -- --id brine-mycelium-shelf
npm run articulated:prepare-plan -- --id brine-mycelium-shelf --plan tools/scratch/brine-mycelium-shelf-starter-plan.json --preview public/review/articulated/brine-mycelium-shelf-plan-preview.png
