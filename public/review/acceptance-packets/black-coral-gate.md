# Acceptance Packet: Black Coral Gate (black-coral-gate)
...
- Runtime id: `black-coral-gate`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/black-coral-gate.md`
- Rigging pack: `rigging-packs/black-coral-gate.md`
- Sandbox URL: `/?sandbox=black-coral-gate`
...
```bash
npm run content:rigging-pack -- --id black-coral-gate
npm run articulated:prepare-plan -- --id black-coral-gate --plan tools/scratch/black-coral-gate-starter-plan.json --preview public/review/articulated/black-coral-gate-plan-preview.png
