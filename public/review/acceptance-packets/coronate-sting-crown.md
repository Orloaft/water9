# Acceptance Packet: Coronate Sting Crown (coronate-sting-crown)
...
- Runtime id: `coronate-sting-crown`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/coronate-sting-crown.md`
- Rigging pack: `rigging-packs/coronate-sting-crown.md`
- Sandbox URL: `/?sandbox=coronate-sting-crown`
...
```bash
npm run content:rigging-pack -- --id coronate-sting-crown
npm run articulated:prepare-plan -- --id coronate-sting-crown --plan tools/scratch/coronate-sting-crown-starter-plan.json --preview public/review/articulated/coronate-sting-crown-plan-preview.png
