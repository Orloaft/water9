# Unmapped Prototype Packet: Trap-Jaw Bristle (trap-jaw-bristle)
...
- Sandbox URL: `/?sandbox=trap-jaw-bristle`

```bash
npm run sandbox:preview -- --id trap-jaw-bristle --with diver --serve --open --visual
npm run sandbox:visual -- --ids trap-jaw-bristle --states idle,lunge,stunned --with diver
npm run content:acceptance-audit -- --id trap-jaw-bristle
```
