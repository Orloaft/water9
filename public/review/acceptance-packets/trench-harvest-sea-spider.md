# Acceptance Packet: Trench Harvest Sea Spider (trench-harvest-sea-spider)
...
- Runtime id: `trench-harvest-sea-spider`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/trench-harvest-sea-spider.md`
- Rigging pack: `rigging-packs/trench-harvest-sea-spider.md`
- Sandbox URL: `/?sandbox=trench-harvest-sea-spider`
...
```bash
npm run content:rigging-pack -- --id trench-harvest-sea-spider
npm run articulated:prepare-plan -- --id trench-harvest-sea-spider --plan tools/scratch/trench-harvest-sea-spider-starter-plan.json --preview public/review/articulated/trench-harvest-sea-spider-plan-preview.png
