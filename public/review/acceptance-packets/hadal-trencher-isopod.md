# Acceptance Packet: Hadal Trencher Isopod (hadal-trencher-isopod)
...
- Runtime id: `hadal-trencher-isopod`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/hadal-trencher-isopod.md`
- Rigging pack: `rigging-packs/hadal-trencher-isopod.md`
- Sandbox URL: `/?sandbox=hadal-trencher-isopod`
...
```bash
npm run content:rigging-pack -- --id hadal-trencher-isopod
npm run articulated:prepare-plan -- --id hadal-trencher-isopod --plan tools/scratch/hadal-trencher-isopod-starter-plan.json --preview public/review/articulated/hadal-trencher-isopod-plan-preview.png
