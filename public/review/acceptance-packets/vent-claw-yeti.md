# Acceptance Packet: Vent-Claw Yeti (vent-claw-yeti)
...
- Runtime id: `vent-claw-yeti`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/vent-claw-yeti.md`
- Rigging pack: `rigging-packs/vent-claw-yeti.md`
- Sandbox URL: `/?sandbox=vent-claw-yeti`
...
```bash
npm run content:rigging-pack -- --id vent-claw-yeti
npm run articulated:prepare-plan -- --id vent-claw-yeti --plan tools/scratch/vent-claw-yeti-starter-plan.json --preview public/review/articulated/vent-claw-yeti-plan-preview.png
