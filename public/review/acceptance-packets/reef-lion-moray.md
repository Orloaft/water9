# Acceptance Packet: Reef Lion Moray (reef-lion-moray)
...
- Runtime id: `reef-lion-moray`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/reef-lion-moray.md`
- Rigging pack: `rigging-packs/reef-lion-moray.md`
- Sandbox URL: `/?sandbox=reef-lion-moray`
...
```bash
npm run content:rigging-pack -- --id reef-lion-moray
