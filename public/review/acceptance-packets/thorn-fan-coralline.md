# Acceptance Packet: Thorn Fan Coralline (thorn-fan-coralline)
...
- Runtime id: `thorn-fan-coralline`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/thorn-fan-coralline.md`
- Rigging pack: `rigging-packs/thorn-fan-coralline.md`
- Sandbox URL: `/?sandbox=thorn-fan-coralline`
...
```bash
npm run content:rigging-pack -- --id thorn-fan-coralline
