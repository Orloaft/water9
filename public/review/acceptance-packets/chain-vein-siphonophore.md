# Acceptance Packet: Chain Vein Siphonophore (chain-vein-siphonophore)
...
- Runtime id: `chain-vein-siphonophore`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/chain-vein-siphonophore.md`
- Rigging pack: `rigging-packs/chain-vein-siphonophore.md`
- Sandbox URL: `/?sandbox=chain-vein-siphonophore`
...
```bash
npm run content:rigging-pack -- --id chain-vein-siphonophore
npm run articulated:prepare-plan -- --id chain-vein-siphonophore --plan tools/scratch/chain-vein-siphonophore-starter-plan.json --preview public/review/articulated/chain-vein-siphonophore-plan-preview.png
