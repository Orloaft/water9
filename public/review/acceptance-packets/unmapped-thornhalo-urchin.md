# Unmapped Prototype Packet: Thornhalo Urchin (thornhalo-urchin)
...
- Sandbox URL: `/?sandbox=thornhalo-urchin`

```bash
npm run sandbox:preview -- --id thornhalo-urchin --with diver --serve --open --visual
npm run sandbox:visual -- --ids thornhalo-urchin --states idle,lunge,stunned --with diver
npm run content:acceptance-audit -- --id thornhalo-urchin
```
