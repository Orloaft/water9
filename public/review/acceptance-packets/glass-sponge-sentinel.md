# Acceptance Packet: Glass Sponge Sentinel (glass-sponge-sentinel)
...
- Runtime id: `glass-sponge-sentinel`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/glass-sponge-sentinel.md`
- Rigging pack: `rigging-packs/glass-sponge-sentinel.md`
- Sandbox URL: `/?sandbox=glass-sponge-sentinel`
...
```bash
npm run content:rigging-pack -- --id glass-sponge-sentinel
