# Acceptance Packet: Tripod Stilt Stalker (tripod-stilt-stalker)
...
- Runtime id: `tripod-stilt-stalker`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/tripod-stilt-stalker.md`
- Rigging pack: `rigging-packs/tripod-stilt-stalker.md`
- Sandbox URL: `/?sandbox=tripod-stilt-stalker`
...
```bash
npm run content:rigging-pack -- --id tripod-stilt-stalker
npm run articulated:prepare-plan -- --id tripod-stilt-stalker --plan tools/scratch/tripod-stilt-stalker-starter-plan.json --preview public/review/articulated/tripod-stilt-stalker-plan-preview.png
