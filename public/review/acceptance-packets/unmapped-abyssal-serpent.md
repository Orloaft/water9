# Unmapped Prototype Packet: Abyssal Serpent (abyssal-serpent)
...
- Sandbox URL: `/?sandbox=abyssal-serpent`

```bash
npm run sandbox:preview -- --id abyssal-serpent --with diver --serve --open --visual
npm run sandbox:visual -- --ids abyssal-serpent --states idle,lunge,stunned --with diver
npm run content:acceptance-audit -- --id abyssal-serpent
```
