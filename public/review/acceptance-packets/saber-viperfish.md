# Acceptance Packet: Saber Viperfish (saber-viperfish)
...
- Runtime id: `saber-viperfish`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/saber-viperfish.md`
- Rigging pack: `rigging-packs/saber-viperfish.md`
- Sandbox URL: `/?sandbox=saber-viperfish`
...
```bash
npm run content:rigging-pack -- --id saber-viperfish
npm run articulated:prepare-plan -- --id saber-viperfish --plan tools/scratch/saber-viperfish-starter-plan.json --preview public/review/articulated/saber-viperfish-plan-preview.png
