# Acceptance Packet: Razor Kelp Harp (razor-kelp-harp)
...
- Runtime id: `razor-kelp-harp`
- Threat accepted: `false`
- Source review packet: `public/review/source-candidates/source-review-packets/razor-kelp-harp.md`
- Rigging pack: `rigging-packs/razor-kelp-harp.md`
- Sandbox URL: `/?sandbox=razor-kelp-harp`
...
```bash
npm run content:rigging-pack -- --id razor-kelp-harp
npm run articulated:prepare-plan -- --id razor-kelp-harp --plan tools/scratch/razor-kelp-harp-starter-plan.json --preview public/review/articulated/razor-kelp-harp-plan-preview.png
