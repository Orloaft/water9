...
const outDir = resolve('runs/water9-distant-landmark-known-fix-2026-07-04/asset-restore-proof');
...
<main>${cards}</main>`;
  const htmlPath = resolve(outDir, 'water9-distant-landmark-asset-restore-contact-sheet.html');
  const path = resolve(outDir, 'water9-distant-landmark-asset-restore-contact-sheet.png');
...
try {
  ...
  const notesPath = resolve(outDir, 'water9-distant-landmark-asset-restore-provenance.json');
  const notes = {
    schema: 'water9-distant-landmark-asset-restore-proof@1',
