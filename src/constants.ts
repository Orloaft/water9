...
export const BARGE_UPGRADE_COST = 7500;
export const MARLIN_VOUCHER_DISCOUNT = 12000;
...
export const FORWARD_OUTPOST_MIN_DEPTH = 900;
export const FORWARD_OUTPOST_FLORA_RADIUS = 150;
export const FORWARD_OUTPOST_TERRAIN_RADIUS_TILES = 3;
export const FORWARD_OUTPOST_OXYGEN_RADIUS = 118;
export const FORWARD_OUTPOST_OXYGEN_REFILL = 18;
export const FORWARD_OUTPOST_MAX_CHARGE = 160;
