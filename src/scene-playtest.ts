...
export function playtestSnapshot(this: DeepdiveScene, ) {
    ...
    return {
      ...
      fish: this.fish.map((fish) => ({
        ...
        phase: roundMetric(fish.phase),
        spriteTextureKey: fish.sprite?.texture?.key ?? null,
        spriteFrameName: fish.sprite?.frame?.name ?? null,
        spriteFrameCutX: roundMetric(fish.sprite?.frame?.cutX ?? null),
